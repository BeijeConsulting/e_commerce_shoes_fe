import { getData, getDataAuth, postData } from "../genericAxios/genericAxios";
...
export async function signOut() {
  ...
  const response = await postData("/sign_out", { refreshToken: refreshTokenStorage }, tokenStorage);
